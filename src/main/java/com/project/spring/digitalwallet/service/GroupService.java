...
public class GroupService {
    ...
    public String updateTagetMoneyGroup(String groupName,int money,String currency,String username) {
        ...
        Account sender =
            accountService
                .getByCurrencyAndWalletId(currency, user.getWalletId());
    	...
    	if(group.getCurrentMoney()>=group.getTargetMoney()) {
    		...
    		accountService.updateBalance(sender.getId(),BigDecimal.valueOf(money).subtract(BigDecimal.valueOf(rest)).negate());
